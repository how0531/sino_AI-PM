...
- 甘特圖：新版 Planner 內建時間表檢視（零開發）；跨專案用 Power BI Gantt 視覺效果嵌 Teams 頁籤。Agent 負責丟連結＋口頭摘要
...
- [ ] 競賽簡報第 2～6 頁改寫成多 agent 版本（成品：outputs/智能專案經理AIPM_競賽提案_已填.pptx 目前是單一 agent 聚焦版）
- [ ] 總架構流程圖重畫（取代第 5 頁現有的單 agent 閉環圖 outputs/AIPM_agent_flow.png）
- [ ] 第 6 頁量化數字換成真實值（目前是範例：100 場會/年、30 分→5 分）
